     ...
     class pantallaCrearRutina3 extends Component {
      ...
      constructor(props){
        ...
        render(){
          ...
          var selectedHours1 = 0;
          var selectedMinutes1 = 0;

          var selectedHours2 = 0;
          var selectedMinutes2 = 0;
          ...
          <Grid>
            ...
            <View>
              <Text style={{fontSize: 25, color: '#525D3B',
                            fontWeight: 'bold'
            }}> {this.state.selectedHours1}:{this.state.selectedMinutes1} </Text>
              ...
              <View style={{height: 150, width: width}}>
                ...
                <Text style={{color: '#525D3B'}}> Hora </Text>
                      ...
                      <Picker
                        selectedValue={this.state.selectedHours1}        
                        onValueChange={(itemValue, itemIndex) => {
                          this.setState({
                            selectedHours1: itemValue
                          })
                          selectedHours1=itemValue;
                        } }
                      >
                ...
                <Text style={{fontSize: 25, color: '#525D3B',
                            fontWeight: 'bold'
            }}> {this.state.selectedHours2}:{this.state.selectedMinutes2} </Text>

              <Text style={{color: '#525D3B'}}> Hora </Text>
              <Picker
                selectedValue={this.state.selectedHours2}        
                onValueChange={(itemValue, itemIndex) => {
                  this.setState({
                    selectedHours2: itemValue
                  })
                  selectedHours2=itemValue;
                } }
              >
              ...
              <Text style={{color: '#525D3B'}}> Minuto </Text>
              <Picker
                selectedValue={this.state.selectedMinutes2}        
                onValueChange={(itemValue, itemIndex) => {
                  this.setState({
                    selectedMinutes2: itemValue
                  })
                  selectedMinutes2=itemValue;
                } }
              >
